      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item">
              <a class="nav-link" href="login.php" target="_parent">Login</a>
            </li>
            <button
              type="button"
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img
            src="https://i.ytimg.com/vi/b077dFu5PLs/oar2.jpg?sqp=-oaymwEkCJUDENAFSFqQAgHyq4qpAxMIARUAAAAAJQAAyEI9AICiQ3gB&rs=AOn4CLB1mALlrIC72Y2EJsXza78Y2zptxA"
            class="img-fluid"
            width="300"
          />
          <div>
            ...
            <h4 class="lead display-6">― Carl Edward Sagan</h4>
            <h6>
